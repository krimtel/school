													...
													'<div class="student-per-info">'+
															...
															'<div class="student-per-info2">'+
																'<table class="table">'+
																	...
																	'<tr><td>Attnd. Session End</td><td>: '+ parseInt(parseInt(value.student_detail.student[0].presentday) - parseInt(value.student_detail.student[0].attend)) +'/'+ parseInt(parseInt(value.student_detail.student[0].working_days) - parseInt(value.student_detail.student[0].mid_days)) +'</td></tr>'+
																'</table>'+
															'</div>'+
														'</div>'+
													'</div>'+
																			...
																			'<thead>'+
																				'<tr><th>Term 1 [on a 3-point (A-C) grading scale]</th><th>Grade</th></tr>'+
																					'</thead>'+
																						...
																						'</div>'+
																						'<div class="col-md-6 teacher-remark">';		
																							if(response.data[0].student_detail.student[0].class_id == 3){
																								x = x + '<p>Promoted to Class: I</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 4){
																								x = x + '<p>Promoted to Class: II</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 5){
																								x = x + '<p>Promoted to Class: III</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 6){
																								x = x + '<p>Promoted to Class: IV</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 7){
																								x = x + '<p>Promoted to Class: V</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 8){
																								x = x + '<p>Promoted to Class: VI</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 9){
																								x = x + '<p>Promoted to Class: VII</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 10){
																								x = x + '<p>Promoted to Class: VIII</p></div>';				
																							}
																							if(response.data[0].student_detail.student[0].class_id == 11){
																								x = x + '<p>Promoted to Class: IX</p></div>';				
																							}																						
																						x = x +'</div>'+
																						'<div class="modal-footer p-footer-sec-f" style="padding-left:0px;margin-top:-15px;">'+
															...
															if(typeof response.data.back != 'undefined'){
																if(response.data.back.category == 'Detained'){
																	if(value.extra){
																		...
																		x = x +	'<tr><td>FOIT</td><td>40</td><td>'+ value.thory +'*</td><td>60</td><td>'+ value.practical +'</td><td>'+ parseInt(parseInt(value.thory) + parseInt(value.practical))  +'</td><td>'+ grade +'</td></tr>';
																	}
																	else{
																		var grade_no = Math.round(parseInt(parseInt(value.thory) + parseInt(value.practical)));
																		console.log(grade_no);
																		...
																		x = x +	'<tr><td>FOIT</td><td>40</td><td>'+ value.thory + value.stars +'</td><td>60</td><td>'+ value.practical +'</td><td>'+ parseInt(parseInt(value.thory) + parseInt(value.practical))  +'</td><td>'+ grade +'</td></tr>';
																	}
																}
																else{
																	...
																	x = x +	'<tr><td>FOIT</td><td>40</td><td>'+ parseInt(parseInt(value.thory) + parseInt(value.extra)) + value.stars +'</td><td>60</td><td>'+ value.practical +'</td><td>'+ parseInt(parseInt(parseInt(value.thory)+parseInt(value.extra)) + parseInt(value.practical))  +'</td><td>'+ grade +'</td></tr>';
																}
															}
															else{
																var grade_no = Math.round(parseInt(parseInt(parseInt(value.thory)+parseInt(value.extra)) + parseInt(value.practical)));
...
'<div class="teacher-remark">'+
						'<table class="table"><tbody><tr><td><b>Result:</b></td>';
							var category = '';
							if(typeof response.data.back != 'undefined'){
								if(response.data.back.category == 'Detained'){
									category = '<td><b>Detained</b></td>';
								}
								else{
									category = '<td><b>Compartment</b></td>  <td><b>'+ response.data.back.subject +'</b></td>';
								}
							}
							else{
								if(typeof response.data.get_extra != 'undefined'){
									if(response.data.get_extra){
										category = '<td><b>Promoted</b></td>';
									}
									else{
...
//									category = '<td><b>Passed</b></td>';
//								}
//								else{
//									category = '<td><b>Compartment</b></td>  <td><b>Retest in English</b></td>';
//									//category = 'Promoted';
//								}
//							}
//							else{
