					  ...
					  x = x +'<img src="../../assest/images/shakuntala/result_bg_logo-w.png" style="position:absolute;top:35%;left:30%;margin:0 auto; background-size:cover; background-position:center;">';
			  			...
			  			'<div class="modal-body p-student-body">'+
							'<div class="student-Information" >'+
								'<div class="text-center"><h5><b>Academic Session: 2017-18<br>Report Card For I-VIII</b></h5></div>'+
								'<div class="col-md-10 p-student-info">'+
										'<div class="student-info-t"><b>STUDENT PARTICULARS</b></div>'+
										'<div class="student-per-info">'+
												'<div class="student-per-info1">'+	
...
//															mi_marks = ((40 * fit)/100).toFixed(2);
								...
								'</table>'+
							'</div>'+
							'<div class="results-information p-results-information-f-c col-md-12" style="margin-top:0px;">'+	
								'<div class="academic-result-t"><b>Co-Scholastic Areas</b></div>'+
					...
					'</div>'+
								'<div class="results-information p-results-information-f-c col-md-12" style="margin-top:8px;margin-bottom:6px;">'+	
										...
										'</table>'+
								'</div>'+
'<div class="col-md-6 teacher-remark"><p><b>Class Teacher&#8217;s remarks: ...................................... </b></p>'+
													...
													'<div class="student-per-info">'+
															...
															'<div class="student-per-info2">'+
																'<table class="table">'+
																	...
																	'<tr><td>Attnd. Mid.Term</td><td>: '+ value.student_detail.student[0].presentday +'/'+ value.student_detail.student[0].working_days +'</td></tr>'+							
																'</table>'+
															'</div>'+
														'</div>'+
													'</div>'+
 			...
 			x = x + '<div class="modal-header p-header">'+
							...
							'</div>'+
	  						'<div class="modal-body p-student-body nine-result">'+
								'<div class="student-Information" >'+
									'<div class="text-center"><h5><b>Academic Session: 2017-18<br>Report Card For XI-X</b></h5></div>'+
'<div class="col-md-10 p-student-info">'+
										'<div class="student-info-t"><b>STUDENT PARTICULARS</b></div>'+
										'<div class="student-per-info">'+
												'<div class="student-per-info1">'+	
												...
												'<tbody>'; 
													$.each(response.data.marks,function(key,value){
														if(value.sub_name != 'FIT'){
															x = x +	'<tr><td style="text-align:left;">'+ value.sub_name +'</td><td>'+ value.priodic +'</td><td>'+ value.notebook +'</td><td>'+ value.subjenrich +'</td><td>'+ value.annual_mark +'</td><td>'+ value.annualsub_total + value.stars +'</td><td>'+ value.grade +'</td></tr>';
														}
													});
												x = x + '</tbody>'+
											'</table>'+
										'</div>'+
										'<div class="results-information p-results-information-f-a col-md-12" style="margin-top:8px;">'+
											'<table class="table">'+
												'<thead>'+
													'<tr><th rowspan="2" style="width:18%;">Subject</th><th colspan="3">Annual Marks</th><th>Periodic Test:</th><th>Note Book: </th><th>Sub Enrichment:</th><th>Annual Examination:</th><th>Marks Obtained:</th><th rowspan="2">Grade</th></tr>'+
													'<tr><th>Th: 60</th><th>Pr: 40</th><th>Total: 100</th><th>10</th><th>05</th><th>05</th><th>80</th><th>100</th></tr>'+
												...
												'<tbody>';
													$.each(response.data.marks,function(key,value){
														if(value.sub_name == 'FIT'){
															x = x +	'<tr><td>'+ value.sub_name +'</td><td>'+ value.thory +'</td><td>'+ value.practical +'</td><td>'+ parseInt(parseInt(value.thory)+parseInt(value.practical)) +'</td><td>'+ value.priodic +'</td><td>'+ value.notebook +'</td><td>'+ value.subjenrich +'</td><td>'+ value.annual_mark +'</td><td>'+ value.annualsub_total +'*</td><td>'+ value.grade +'</td></tr>';
														}
													});
												x = x +'</tbody>'+
											'</table>'+
										'</div>'+
										'<div class="results-information p-results-information-f-c col-md-6" style="margin-top:8px;margin-bottom:6px;">'+
											'<table class="table">'+
												'<thead>'+
												...
												'<tbody>'+
													'<tr><td style="text-align:left;">Work Education</td><td>A</td></tr>'+
													'<tr><td style="text-align:left;">Art Education</td><td>A</td></tr>'+
													'<tr><td style="text-align:left;">Health & Physical Education</td><td>A</td></tr>'+
													'<tr><td style="text-align:left;">Computer Awareness</td><td>A</td></tr>'+
													'<tr><td style="text-align:left;">Discipline</td><td>A</td></tr>'+
												'</tbody>'+
											'</table>'+
										'</div>'+
										'<div class="col-md-6 teacher-remark"><p><b>Class Teacher&#8217;s remarks: ...................................... </b></p>'+
						'<p>Result: Detained </p></div>'+				
'</div>'+
