...
$(document).on('click','.final_result',function(){
	...
	$.ajax({
		type: 'POST',
		url: baseUrl+'Admin_ctrl/new_window_compart_high_class_final',
		dataType: "json",
		data: {
			'sid' : s_id,
			'class_id' : class_id,
			...
			x = x + '<link rel="stylesheet" type="text/css" href="'+ baseUrl +'assest/bootstrap/css/bootstrap.min.css">'+
					...
					'</div>'+
		  			...
		  			'<div class="modal-body p-student-body">'+
						...
						'<table class="table" width="50%" style="margin-top:10px;">'+
							'<thead>';
								...
								x = x + '<tr><th>S.No.</th><th>Subject</th><th>MM</th><th>Mark OBT</th></tr>'+
							'</thead>'+
							'<tbody>';
							var cc = 1;
