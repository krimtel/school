										...
										'<div class="student-per-info">'+
												...
												'<div class="student-per-info2">'+
													'<table class="table">'+
														...
														'<tr><td>Attnd. Session End</td><td>: '+ parseInt(parseInt(response.data.student[0].presentday) - parseInt(response.data.student[0].attend))  +'/'+ response.data.student[0].working_days +'</td></tr>'+
													'</table>'+
												'</div>'+
											'</div>'+
										'</div>'+
...
'<div class="teacher-remark">'+
						'<table class="table"><tbody><tr><td><b>Aggrigate</b></td><td><b>'+ aggrigate.toFixed(2) +'/500</b></td><td><b>Result:</b></td>';
							var category = '';
							if(typeof response.data.back != 'undefined'){
								if(response.data.back.category == 'Detained'){
...
'<div class="teacher-remark">'+
						'<table class="table"><tbody><tr><td><b>Aggrigate</b></td><td><b>'+ aggrigate.toFixed(2) +'/500</b></td><td><b>Result:</b></td>';
							var category = '';
							if(typeof vvalue.back != 'undefined'){
								if(vvalue.category == 'Detained'){
									category = '<td><b>Detained</b></td>';
								}
								else{
									category = '<td><b>Compartment</b></td>  <td><b>'+ vvalue.back.subject +'</b></td>';
								}
							}
							else{
								if(typeof vvalue.get_extra != 'undefined'){
									if(response.data.get_extra){
										category = '<td><b>Promoted</b></td>';
									}
									else{
