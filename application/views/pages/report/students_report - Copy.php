<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Students Reports
      	...
      	<?php if($power == 5) { ?>
      		<div><input type="text" id="advance_search" name="advance_search" placeholder="Search by admission no."></div>
      	<?php } ?>
      <ol class="breadcrumb">
	...
	<div class="box-body table-responsive no-padding">
			  ...
			  <table class="table table-hover table-striped student-records-list-h">
                <thead><tr>
                  <th>S.No.</th>
                  <th>Edit/Del.</th>
                  <th>Image</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					<select class="form-control" id="stu_gender">
...
function student_render(response){
	...
	x = x + '<tr>'+
				...
				'</td>'+
				'<td><img width="30" src="'+ baseUrl +'photos/students/<?php echo strtolower($this->session->userdata('school'));?>/'+ value.photo +'"></td>'+
				'<td><input class="dynamic numaric" style="width:90px;" data-column="aadhar" data-id="'+ value.s_id +'" type="text" id="stu_aadhar" value="'+ value.aadhar +'" disabled="disabled" maxlength="12"></td>'+
				...
				x = x + '</td>'+
				'<td><input style="width:40px;" class="dynamic" data-column="roll_no" data-id="'+ value.s_id +'" type="text" id="stu_rollno" value="'+ value.roll_no +'"></td>'+
				'<td><input style="width:40px;" class="dynamic" data-column="admission_no" data-id="'+ value.s_id +'" type="text" id="stu_admission_no" value="'+ value.admission_no +'"></td>'+
				'<td><input style="width:70px;" class="dynamic" data-column="admission_date" data-id="'+ value.s_id +'" type="text" id="stu_admission_date" value="'+ value.admission_date +'"></td>'+
				'<td><input class="dynamic" data-column="father_name" data-id="'+ value.s_id +'" type="text" id="stu_admission_date" value="'+ value.father_name +'"></td>'+
				'<td><input class="dynamic" data-column="mother_name" data-id="'+ value.s_id +'" type="text" id="stu_admission_date" value="'+ value.mother_name +'"></td>'+
				'<td><input style="width:70px;" class="dynamic" data-column="dob" data-id="'+ value.s_id +'" type="text" id="stu_dob" value="'+ value.dob +'"></td>'+
				'<td>'+
			...
			'</td>'+
				...
				'<td><input style="width:75px;" class="dynamic numaric" data-column="contact_no" data-id="'+ value.s_id +'" type="text" id="stu_dob" value="'+ value.contact_no +'" maxlength="10"></td>'+
				'<td>'+
				...
				'<td>'+
					...
					'</select>'+
				'</td>'+
				'<td><input style="width:45px;" class="dynamic" data-column="height" data-id="'+ value.s_id +'" type="text" id="stu_height" value="'+ value.height +'"></td>'+
				'<td><input style="width:45px;" class="dynamic" data-column="weight" data-id="'+ value.s_id +'" type="text" id="stu_weight" value="'+ value.weight +'"></td>'+
...
$(document).on('click','#export-to-excel',function(){
	...
	if(form_valid){
		$.ajax({  
			...
			success:function(response){
				var x = baseUrl;
				x = x +  'backup/'+ response.data.file_name;
			...
			$.ajax({  
				...
				success : function (response){
					if(response.status == 200){
						...
						$('#datepicker2').val(response.data[0].admission_date);
...
$(document).on('click','#form-submit',function(){
  ...
  $(document).on('keyup','#advance_search',function(){
	  var string = $(this).val();
	  $.ajax({
			type: 'POST',
