    ...
    <section class="content">
      <div class="row">
       ...
       <section class="col-lg-12">
			...
			<form id="csv-form" method="post" action="<?php echo base_url() ?>Marks_entry_cc/add_marks_csv" enctype="multipart/form-data">
            ...
            <!-- 
             <form method="post" action="<?php echo base_url() ?>Marks_entry_cc/add_marks_csv" enctype="multipart/form-data">
...
<script src="<?php echo base_url(); ?>assest/bootstrap/js/papaparse.min.js"></script>
