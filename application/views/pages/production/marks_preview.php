<div class="content-wrapper">
      ...
      <div class="row">
		...
		<div class="box box-primary">
			...
			<div class="box-footer">
				<button type="button" class="btn pull-right btn-info btn-space" id="classwise_final">Classwise Final Report</button> 
				<button type="button" class="btn pull-right btn-info btn-space" id="classwise_pre_mid">Classwise Pre + Mid Report</button> 
 ...
 <script src="<?php echo base_url();?>assest/bootstrap/js/mark_sheet_preview.js"></script>
 <script src="<?php echo base_url();?>assest/bootstrap/js/final_fard.js"></script>