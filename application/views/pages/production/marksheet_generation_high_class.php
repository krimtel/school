      ...
      <div class="row">
		...
		<div class="box box-primary">
			...
			<div class="box-footer">
				...
				<a class="btn pull-right btn-info btn-space fullmarks" id="full_multi_marksheet">Full Marksheet</a> 
...
<script src="<?php echo base_url();?>assest/bootstrap/js/mark_sheet_genration_high_class.js"></script>