<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Compartment Marksheet</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
			  <h3 class="box-title">Search Compartment Marksheet</h3>
			...
			<div class="box-footer">
				<button type="reset" class="btn pull-right btn-info">Compartment Marksheet</button> 
			...
			<div class="box-body table-responsive no-padding">
              ...
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td>123</td>
                  <td>1274</td>
                  <td><a class="btn btn-info btn-md">Print</a></td>
                </tr>
				<tr>
                   <td>1.</td>
                  <td>amit</td>
